...
class Produto(models.Model):
    ...
    preço = models.DecimalField("Preço do produto", max_digits=15, decimal_places=4)  # TODO Embora na maioria dos casos possa funcionar, evitar usar caracteres especiais no nome de variaveis/classe, etc.
                                                                                      # TODO É realmente necessário que sejam 4 casas decimais?
    data_preco = models.DateTimeField("Data do preço")  # TODO Esse campo é pra gravar qual informação? A data de criação ou de alteração?
...
class Usuario(models.Model):  # TODO Acredito que esse modelo de usuário não funcionará pra fazer a autenticação. O django precisa de um modelo de usuário de uma forma específica.
                              # TODO https://www.codingforentrepreneurs.com/blog/how-to-create-a-custom-django-user-model
...
class TipoPedido(models.Model):  # TODO Criar alguma forma de constantes com os tipos de pedidos existentes (mesma ideia de um enumerator de C#)
...
class Pedido(models.Model):
    usuario = models.ForeignKey(Usuario, on_delete=models.CASCADE)  # TODO O cascade é realmente a opção ideal aqui?
    tipo = models.ForeignKey(TipoPedido, on_delete=models.CASCADE)
    justificativa = models.CharField("Justificativa", max_length=150)  # TODO Esse campo é sempre obrigatório?
